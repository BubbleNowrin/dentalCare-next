...
const defaultFaq = [
  {
    ...
    a:
      "Dental implants are artificial tooth roots made of titanium that are surgically placed into the jawbone. They provide a strong foundation for fixed or removable replacement teeth that look and function like natural teeth.",
  },
  {
    q: "Who is a good candidate for dental implants?",
    a:
      "Most adults with healthy gums and adequate bone structure are candidates for dental implants. A consultation and evaluation are necessary to determine if implants are right for you.",
  },
  {
    q: "Is the dental implant procedure painful?",
    a:
      "The procedure is performed under local anesthesia or sedation, so most patients experience minimal discomfort. Mild soreness after surgery is normal and can be managed with over-the-counter pain medication.",
  },
  {
    q: "How long do dental implants last?",
    a:
      "With proper care and regular dental visits, dental implants can last a lifetime. Good oral hygiene and healthy lifestyle habits are essential for long-term success.",
  },
];
